...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof until, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'until a test condition is true, the function invokes a provided function', function test( t ) {
	var out = [];
